...
if [ $(grep -E "Debian" /etc/*-release | wc -l) -ge 1 ]; then
        ...
        yum install -y autoconf libxml2-devel libjpeg-devel libpng-devel libxml2-devel git ImageMagick-devel wget gcc openssl-devel libcurl-devel uw-imap-devel libc-client libicu-devel gcc-c++ libxslt-devel openldap-devel redis mailx.x86_64 sqlite-devel oniguruma-devel gmp-devel
